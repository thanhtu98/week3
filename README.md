...
## Bài 1:
+sử dụng JDBC kết nối mysql(dùng xampp) với java
+cấu trúc code:
*   class City : thể hiện đối tượng thành phố
*   class Country : thể hiện đối tượng quốc gia
*   class Main : thực hiện các lệnh truy vấn theo yêu cầu
+class Main: sử dụng lambda và stream api kết hợp với lệnh truy vấn sql để giải quyết bài toán
